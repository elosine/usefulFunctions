...
function mkPanel(panelid, canvas, w, h, title, posArr) {
  var tpanel;
...
function mkCtrlPanel(id, w, h, title, posArr) { //posArr=all strings:[ left-top, xOffset, yOffset, autoposition]
  var canvasID = id + 'canvas';
  var canvas = mkCanvasDiv(canvasID, w, h, 'black');
  var panelID = id + 'panel';
  var panel = mkPanel(panelID, canvas, w, h, title, posArr);
}
